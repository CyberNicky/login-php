            ...
            <div class="relative bg-white pt-10 pb-8 px-10 shadow-xl mx-auto w-96 rounded-lg">
                <div class="divide-y divide-gray-300/50 w-full">
                    <div class="space-y-6 py-8 text-base  text-gray-600">
                        ...
                        <p class="text-xl font-medium leading-7">Cadastre-se</p>
                        <div class="space-y-4 flex flex-col">
                            ...
                            <input type="password" name="passwordConfirmation" placeholder="Password Confirmation" class="border border-gray-300/50 p-1 rounded focus:outline-none" />
                        </div>
                    </div>
                    <div class="pt-8 text-base font-semibold leading-7">
                        ...
                        <input type='button' onclick="window.location.href='index.php' " class="bg-sky-500 hover:bg-sky-600 px-4 py-1 text-white rounded" value='Ir para o login' />
